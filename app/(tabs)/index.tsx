...
// Import the employer dashboard component
import EmployerDashboardScreen from "../employer-dashboard";
...
export default function DashboardScreen() {
  ...
  // If user is an employer, show the employer dashboard
  if (isEmployer) {
      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.greeting}>
            {isEmployer ? 'Employer Dashboard' : `Welcome back, ${currentProfile.name}`}
          </Text>
